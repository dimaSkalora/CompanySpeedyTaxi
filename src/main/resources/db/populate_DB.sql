...
DELETE FROM access_to_route;
DELETE FROM taxi_dispatchers;
DELETE FROM taxi_dispatcher_orders;
DELETE FROM taxi_user_orders;
DELETE FROM type_payment;
DELETE FROM type_bank_card;
DELETE FROM bank_card;
DELETE FROM user_bank_card;
DELETE FROM refilling_car;
DELETE FROM taxi_order_acceptance;
DELETE FROM taxi_route_on_orders;
DELETE FROM taxi_route;
DELETE FROM coming_consuption_fuel;
DELETE FROM bank_card_operations;
DELETE FROM taxi_user_vehicle_info;
DELETE FROM taxi_job_status;
DELETE FROM departments_company;
DELETE FROM payroll_accounting;
DELETE FROM pay_sheet;
...
INSERT INTO user_roles (user_id, role) VALUES
 ...
 (100000,'ROLE_REFUELLING_MUSTANG'),
 (100001,'ROLE_COMPANY'),
 (100001,'ROLE_DRIVER'),
 (100002,'ROLE_USER'),
 (100003,'ROLE_USER'),
...
---------------vehicles---------------3
INSERT INTO vehicles (id,name_car, vehicle_number, year_issue, category, color, fuel_consumption) VALUES
...
---------------user_vehicles---------------4
INSERT INTO user_vehicles (id, id_user, id_vehicle, is_current_user_machine) VALUES
 (1, 100005, 2, 1),
 (2, 100006, 4, 1),
 (3, 100007, 6, 1),
 (4, 100008, 8, 1);
...
---------------user_state---------------5
INSERT INTO user_state (id, name_us) VALUES
 (1,'Здоровый'),
 (2,'Больной'),
 (3,'Не трезвый');

---------------vehicle_state---------------6
INSERT INTO vehicle_state (id, name_vs) VALUES
 (1,'Рабочий'),
 (2,'Сломан'),
 (3,'В ремонте');
...
---------------taxi_dispatchers---------------8
INSERT INTO taxi_dispatchers (id, id_user) VALUES
 (1,100010),
 (2,100011);

---------------taxi_dispatcher_orders---------------9
INSERT INTO taxi_dispatcher_orders (id, id_taxi_dispatcher, user_name, user_phone, address_departure, address_arrival, start_date, end_date, fulfilled) VALUES
...
---------------taxi_user_orders---------------10
INSERT INTO taxi_user_orders (id, id_user, address_departure, address_arrival, start_date, end_date, fulfilled) VALUES
...
---------------type_payment---------------11
INSERT INTO type_payment (id, name_tp) VALUES
 (1, 'Зарплата'),
 (2, 'Аванс'),
 (3, 'Премия'),
 (4, 'Больничные'),
 ...
 ---------------type_bank_card---------------12
INSERT INTO type_bank_card (id, type_name) VALUES
 (1, 'Зарплатная'),
 (2, 'Компания'),
 (3, 'Водительская'),
 (4, 'Авто заправная'),
...
---------------bank_card---------------13
INSERT INTO bank_card (id, bank_card_number, id_type_bank_card, money_balance, is_active) VALUES
...
---------------user_bank_card---------------14
INSERT INTO user_bank_card (id, id_user, id_bank_card) VALUES
 (1, 100000, 1),
 (2, 100000, 3),
 (3, 100001, 2),
 (4, 100005, 4),
...
---------------refilling_car---------------15
INSERT INTO refilling_car (id, id_user_vehicle, id_user_bank_card, liter, price_per_liter, payment_of_refueling) VALUES
...
INSERT INTO taxi_order_acceptance (id, id_user_vehicle, id_taxi_dispatcher_order, id_taxi_user_order, execution_status, adoption_status) VALUES
 (1,1,1,null,0,1),
 (2,2,2,null,0,0),
 (3,3,null,1,0,1),
 (4,1,1,null,1,1),
...
INSERT INTO taxi_route_on_orders (id, id_user_vehicle, id_user_bank_card, id_taxi_order_acceptance, landing, tariff_per_kilometer, distance, fare_payment, fuel_consuption) VALUES
 (1, 1, 5, 4, 30.5, 10.0, 8.3, 113.5, 1.3),
 (2, 2, 8, 5, 30.5, 10.0, 15.4, 184.5, 2.2);

---------------taxi_route---------------18
INSERT INTO taxi_route (id, id_user_vehicle, id_user_bank_card, departure_point, arrival_point, start_date, end_date, landing, tariff_per_kilometer, distance, fare_payment, fuel_consuption) VALUES
...
INSERT INTO coming_consuption_fuel (id, date_ccf, id_user_vehicle, consuption, coming, remainder, kilometer, total_kilometer) VALUES
...
INSERT INTO bank_card_operations (id, id_user_bank_card, date_time_arrivel_money, id_bank_card_arrivel, arrival_money, date_time_spending_money, id_bank_card_spending, spending_money, money_balance) VALUES
...
---------------taxi_job_status---------------21
INSERT INTO taxi_job_status (id, name_tjs) VALUES
 (1, 'Свободный'),
 (2, 'Занятый'),
 (3, 'Обед'),
 (4, 'Не рабатаю');
...
INSERT INTO taxi_user_vehicle_info (id, id_user_vehicle, id_taxi_job_status) VALUES
 (1, 1, 2),
 (2, 2, 3),
 (3, 3, 1),
 (4, 4, 4);
...
INSERT INTO departments_company (id, name_dc) VALUES
 (1, 'Бухгалтерия'),
 (2, 'Финансы'),
 (3, 'Администрация'),
 (4, 'Автопарк');
...
INSERT INTO payroll_accounting (id, id_department_company, id_user_bank_card, month_year, norm_number_days_worked_month, number_days_worked_month, stake_days, norm_hours_worked_month, hours_worked_month, stake_hour, payment_date_time, id_type_payment, payout, sum_payout_month) VALUES
...
---------------pay_sheet---------------25
INSERT INTO pay_sheet (id, id_user, id_bank_card, id_department_company, month_year, prepayment, salary, premium, hospitals, holiday, amount_without_taxes, ndfl, esv, vs, amount_with_texas, norm_hours_worked, hours_worked, hours_holiday) VALUES
